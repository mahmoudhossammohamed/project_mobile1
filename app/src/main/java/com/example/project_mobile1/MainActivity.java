package com.example.project_mobile1;
                ...
                dialog = new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(MainActivity.this, "Success Booked Ticket", Toast.LENGTH_LONG).show();
                        ...
                        .setNegativeButton( "No", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                resetDetailTour();
                                Toast.makeText( MainActivity.this, "Fail Booked Ticket", Toast.LENGTH_LONG).show();
                                Intent intent= new Intent( MainActivity.this, MainActivity.class);//Dashboard
